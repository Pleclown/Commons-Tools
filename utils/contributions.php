...
class contributions{
  ...
  QUERY_INTERTWINED_CONTRIBS = 'select top 1000 rev_id, rev_user_text,page_title, rev_timestamp FROM revision, page WHERE (rev_user_text = ? or rev_user_text = ?) AND page_id=rev_page order by rev_id desc'
